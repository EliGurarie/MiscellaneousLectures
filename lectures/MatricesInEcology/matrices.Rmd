...
```{r, fig.height=5, dpi=100, out.width=400, echo = -1}
eliepars()
...
par(mar = c(0,0,0,0), bty = "n", axes = FALSE, bg = "black")
n.frames <- 60
...
par(mar = c(0,0,0,0), bty = "n", axes = FALSE, bg = "black"); palette(gplots::rich.colors(60))
...
```{r morePairsPlots, fig.width = 5, fig.height = 5, echo = -1}
eliepars()
